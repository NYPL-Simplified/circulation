...
class Configuration(CoreConfiguration):
    ...
    LIBRARY_SETTINGS = CoreConfiguration.LIBRARY_SETTINGS + [
        ...
        },
        {
            ...
            "options": [
                dict(key="amber", value=_("Amber")),
                dict(key="black", value=_("Black")),
                dict(key="blue", value=_("Blue")),
                dict(key="bluegrey", value=_("Blue Grey")),
                dict(key="brown", value=_("Brown")),
                dict(key="cyan", value=_("Cyan")),
                dict(key="darkorange", value=_("Dark Orange")),
                dict(key="darkpurple", value=_("Dark Purple")),
                dict(key="green", value=_("Green")),
                dict(key="grey", value=_("Grey")),
                dict(key="indigo", value=_("Indigo")),
                dict(key="lightblue", value=_("Light Blue")),
                dict(key="orange", value=_("Orange")),
                dict(key="pink", value=_("Pink")),
                dict(key="purple", value=_("Purple")),
                dict(key="red", value=_("Red")),
                dict(key="teal", value=_("Teal")),
            ],
            "type": "select",
