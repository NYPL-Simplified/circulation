...
class Configuration(CoreConfiguration):
    ...
    LIBRARY_SETTINGS = CoreConfiguration.LIBRARY_SETTINGS + [
        ...
        },
        {
            ...
            "options": [
                {key="amber" value=_("Amber")},
                {key="black" value=_("Black")},
                {key="blue" value=_("Blue")},
                {key="bluegrey" value=_("Blue Grey")},
                {key="brown" value=_("Brown")},
                {key="cyan" value=_("Cyan")},
                {key="darkorange" value=_("Dark Orange")},
                {key="darkpurple" value=_("Dark Purple")},
                {key="green" value=_("Green")},
                {key="grey" value=_("Grey")},
                {key="indigo" value=_("Indigo")},
                {key="lightblue" value=_("Light Blue")},
                {key="orange" value=_("Orange")},
                {key="pink" value=_("Pink")},
                {key="purple" value=_("Purple")},
                {key="red" value=_("Red")},
                {key="teal" value=_("Teal")},
            ],
            "type": "select",
