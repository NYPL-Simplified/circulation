...
@library_route('/odl_notify/<loan_external_identifier>')
@has_library
@returns_problem_detail
def odl_notify(loan_external_identifier):
    return app.manager.odl_notification_controller.notify(loan_external_identifier)
