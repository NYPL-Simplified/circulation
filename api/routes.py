...
@library_route("/collections/<collection_name>/loans/<loan_id>")
@has_library
@returns_problem_detail
...
@library_route("/collections/<collection_name>/loans/<loan_id>/revoke")
@has_library
@returns_problem_detail
...
@library_route("/collections/<collection_name>/loans/<loan_id>/fulfill", defaults=dict(mechanism_id=None))
@library_route("/collections/<collection_name>/loans/<loan_id>/fulfill/<mechanism_id>")
@has_library
@returns_problem_detail
...
@library_route("/collections/<collection_name>/<identifier_type>/<path:identifier>/place_hold",
               methods=['GET', 'POST'])
@has_library
@returns_problem_detail
def shared_collection_place_hold(collection_name, identifier_type, identifier):
    return app.manager.shared_collection_controller.place_hold(collection_name, identifier_type, identifier)

@library_route("/collections/<collection_name>/holds/<hold_id>")
@has_library
@returns_problem_detail
...
@library_route("/collections/<collection_name>/holds/<hold_id>/revoke")
@has_library
@returns_problem_detail
