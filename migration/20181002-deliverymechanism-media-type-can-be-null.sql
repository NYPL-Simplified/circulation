...
update deliverymechanisms set content_type=NULL where content_type='audio/mpeg' and content_type='application/vnd.librarysimplified.findaway.license+json';
