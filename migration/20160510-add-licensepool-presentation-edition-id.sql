...
update licensepools set licensepools.presentation_edition_id = (select id from editions e where licensepools.data_source_id=e.data_source_id and licensepools.identifier_id=e.primary_identifier_id);
