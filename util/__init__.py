...
class LanguageCodes(object):
    ...
    The native names mapping comes from
...
zza|||Zaza; Dimili; Dimli; Kirdki; Kirmanjki; Zazaki|zaza; dimili; dimli; kirdki; kirmanjki; zazaki"""
    ...
    NATIVE_NAMES_RAW_DATA =  [
        ...
        {"code":"zh","name":"Chinese","nativeName":"äæ (Zhōngwén), æè, æè"},
        ...
        {"code":"ja","name":"Japanese","nativeName":"ææè (にほんご／にっぽんご)"},
        ...
        {"code":"ko","name":"Korean","nativeName":"íêì (éåè), ììë (æéè)"},
        ...
        {"code":"ii","name":"Nuosu","nativeName":"êêê Nuosuhxop"},
    ...
    for i in NATIVE_NAMES_RAW_DATA:
        ...
        names = i['nativeName']
        names = [unicode(x.strip(), 'utf-8') for x in names.split(",")]
