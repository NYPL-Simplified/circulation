...
def test_for_license_pool(db_session, create_edition, create_licensepool):
    # GIVEN: A Complaint
...
def test_success(db_session, create_edition, create_licensepool):
...
def test_success_no_source(db_session, create_edition, create_licensepool):
    # GIVEN: Two Complaints
...
def test_failure_no_licensepool(db_session):
    # GIVEN: A Complaint
...
def test_unrecognized_type(db_session, create_edition, create_licensepool):
    # GIVEN: A Complaint
...
def test_register_resolved(db_session, create_edition, create_licensepool):
    # GIVEN: Two Complaints
...
def test_resolve(db_session, create_edition, create_licensepool):
    # GIVEN: A Complaint
