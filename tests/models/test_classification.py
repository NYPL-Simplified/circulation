...
def test_subject_lookup_errors(db_session):
    # GIVEN: A Subject
...
def test_subject_lookup_autocreate(db_session):
    # GIVEN: A Subject
...
def test_subject_lookup_by_name(db_session, create_subject):
    # GIVEN: A Subject
...
def test_subject_assing_to_genre_can_remove_genre(db_session):
    # GIVEN: A Subject
...
def test_genre_full_table_cache(db_session, populate_genres):
...
def test_genre_by_id(db_session, populate_genres):
...
def test_genre_by_cache_key_miss_triggers_create_function(db_session, populate_genres):
...
def test_genre_by_cache_key_miss_when_cache_is_reset_populates_cache(db_session, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_genre_by_cache_key_hit_returns_cached_object(db_session):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_genre_name_is_unique(db_session):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_genre_default_fiction(db_session, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
    science_fiction, _ = Genre.lookup(db_session, "Science Fiction")
