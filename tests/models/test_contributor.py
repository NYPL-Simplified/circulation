...
def test_marc_code_for_every_role_constant():
...
def test_lookup_by_viaf(db_session):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_lookup_by_lc(db_session):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_lookup_by_viaf_interchangeable(db_session, create_contributor):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_create_by_lookup(db_session):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_default_names(in_name, out_family, out_display, default_display_name):
    f, d = Contributor._default_names(in_name, default_display_name)
    assert f == out_family
    assert d == out_display

def test_sort_name(db_session, create_contributor):
