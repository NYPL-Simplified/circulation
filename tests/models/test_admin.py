...
class TestAdmin:
    ...
    def test_password_hashed(self, db_session, create_admin_user):
        """
        GIVEN: An Admin user
    ...
    def test_with_password(self, db_session, create_admin_user):
        """
        GIVEN: An Admin user
    ...
    def test_with_email_spaces(self, db_session, create_admin_user):
        """
        GIVEN: An Admin user
    ...
    def test_has_password(self, db_session, create_admin_user):
        """
        GIVEN: An Admin user
    ...
    def test_authenticate(self, db_session, create_admin_user):
        """
    ...
    def test_can_see_collection(self, db_session, create_admin_user, create_collection, create_library):
        """
