...
class TestCollection(DatabaseTest):
    ...
    def test_licensepools_with_works_updated_since(self):
        ...
        w1_coverage_record.timestamp = datetime.datetime.now(tz=pytz.UTC)
        assert (
    ...
    def test_isbns_updated_since(self):
        ...
        timestamp = datetime.datetime.now(tz=pytz.UTC)
        i1.coverage_records[0].timestamp = datetime.datetime.now(tz=pytz.UTC)
        ...
        i2.coverage_records[0].timestamp = datetime.datetime.now(tz=pytz.UTC)
