...
def test_lookup(db_session, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_lookup_by_deprecated_name(db_session, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_lookup_returns_none_for_nonexistent_source(db_session, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
    assert None == DataSource.lookup(db_session, "No such data source")

def test_lookup_with_autocreate(db_session, populate_genres):
    # GIVEN:
    # WHEN: 
    # THEN:
...
def test_metadata_sources_for(db_session, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_license_source_for(db_session, create_identifier, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_license_source_for_string(db_session, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
...
def test_license_source_fails_if_identifier_type_does_not_provide_licenses(db_session, create_identifier, populate_genres):
    # GIVEN:
    # WHEN:
    # THEN:
