...
class TestExternalSearchWithWorks(EndToEndSearchTest):
    ...
    def populate_works(self):
        ...
        self.moby_dick.last_update_time = datetime.datetime(2019, 1, 1, tzinfo=pytz.UTC)
        ...
        self.moby_duck.last_update_time = datetime.datetime(2019, 1, 2, tzinfo=pytz.UTC)
...
class TestSearchOrder(EndToEndSearchTest):
    ...
    def populate_works(self):
        ...
        self.a.last_update_time = datetime.datetime(2000, 1, 1, tzinfo=pytz.UTC)
        self.b.last_update_time = datetime.datetime(2001, 1, 1, tzinfo=pytz.UTC)
        self.c.last_update_time = datetime.datetime(2002, 1, 1, tzinfo=pytz.UTC)
        ...
        self.a1.availability_time = datetime.datetime(2010, 1, 1, tzinfo=pytz.UTC)
        self.c1.availability_time = datetime.datetime(2011, 1, 1, tzinfo=pytz.UTC)
        self.b1.availability_time = datetime.datetime(2012, 1, 1, tzinfo=pytz.UTC)
        ...
        self.b2.availability_time = datetime.datetime(2020, 1, 1, tzinfo=pytz.UTC)
        self.a2.availability_time = datetime.datetime(2021, 1, 1, tzinfo=pytz.UTC)
        self.c2.availability_time = datetime.datetime(2022, 1, 1, tzinfo=pytz.UTC)
        ...
        self.list1.add_entry(
            self.b, first_appearance=datetime.datetime(2030, 1, 1, tzinfo=pytz.UTC)
        )
        self.list1.add_entry(
            self.c, first_appearance=datetime.datetime(2031, 1, 1, tzinfo=pytz.UTC)
        )
        self.list1.add_entry(
            self.a, first_appearance=datetime.datetime(2032, 1, 1, tzinfo=pytz.UTC)
        )
        ...
        self.list2.add_entry(
            self.c, first_appearance=datetime.datetime(2001, 1, 1, tzinfo=pytz.UTC)
        )
        self.list2.add_entry(
            self.a, first_appearance=datetime.datetime(2014, 1, 1, tzinfo=pytz.UTC)
        )
        self.list2.add_entry(
            self.b, first_appearance=datetime.datetime(2015, 1, 1, tzinfo=pytz.UTC)
        )
        ...
        self.list3.add_entry(
            self.c, first_appearance=datetime.datetime(1999, 1, 1, tzinfo=pytz.UTC)
        )
        ...
        self.by_publication_date.add_entry(
            self.moby_duck, first_appearance=datetime.datetime(2011, 3, 1, tzinfo=pytz.UTC)
        )
        self.by_publication_date.add_entry(
            self.untitled, first_appearance=datetime.datetime(2018, 1, 1, tzinfo=pytz.UTC)
        )
        ...
        self.staff_picks.add_entry(
            self.moby_dick, first_appearance=datetime.datetime(2015, 5, 2, tzinfo=pytz.UTC)
        )
        self.staff_picks.add_entry(
            self.moby_duck, first_appearance=datetime.datetime(2012, 8, 30, tzinfo=pytz.UTC)
        )
        ...
        self.d.license_pools[0].availability_time = datetime.datetime(2010, 1, 1, tzinfo=pytz.UTC)
        self.e.license_pools[0].availability_time = datetime.datetime(2011, 1, 1, tzinfo=pytz.UTC)

        self.extra_list, ignore = self._customlist(num_entries=0)
        self.extra_list.add_entry(
            self.d, first_appearance=datetime.datetime(2020, 1, 1, tzinfo=pytz.UTC)
        )
        self.extra_list.add_entry(
            self.e, first_appearance=datetime.datetime(2021, 1, 1, tzinfo=pytz.UTC)
        )

        self.e.last_update_time = datetime.datetime(2090, 1, 1, tzinfo=pytz.UTC)
        self.d.last_update_time = datetime.datetime(2091, 1, 1, tzinfo=pytz.UTC)
...
class TestFilter(DatabaseTest):
    ...
    def test_build(self):
        ...
        last_update_time = datetime.datetime(2019, 1, 1, tzinfo=pytz.UTC)
        i1 = self._identifier()
        i2 = self._identifier()
        ...
        expect = (
            last_update_time - datetime.datetime.fromtimestamp(0, tz=pytz.UTC)
        ).total_seconds()
        assert (
            {'bool': {'must': [
