...
class TestSettingsController(SettingsControllerTest):
    ...
    def test_get_integration_protocols(self):
        ...
        expect = dict(
            ...
            instructions="my instructions", settings=[1, 2, 3],
...
<<<<<<< HEAD:tests/admin/controller/test_controller.py
    ...
    #         ])
    #         assert_raises(AdminNotAuthorized,
    #                       self.manager.admin_library_settings_controller.process_get)
    #
    #     with self.request_context_with_admin("/", method="POST"):
    #         flask.request.form = MultiDict([
    #             ("name", "Brooklyn Public Library"),
...
=======
    ...
    def test_library_delete(self):
        ...
        library = get_one(self._db, Library, uuid=library.uuid)
        eq_(None, library)
>>>>>>> bb1c445dddf04417d0558cbaeb3fd80c8b067d24:tests/admin/test_controller.py
